...
@Serializable data class TranslationLearningConsentUpdateRequest(@SerialName("allowsConsentedTranslationLearning") val allowsConsentedTranslationLearning: Boolean)
