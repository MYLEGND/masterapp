...
public sealed class AnalyticsQueryService : IAnalyticsQueryService
{
    ...
    private static bool IsQuoteFunnelStartSignalEvent(AnalyticsEvent e)
    {
        ...
        return AnalyticsEventCatalog.MatchesDashboardMetric(e.EventType, "funnel_start") ||
               ...
               string.Equals(e.EventType, "life_general_form_start", StringComparison.OrdinalIgnoreCase) ||
               string.Equals(e.EventType, "life_term_form_start", StringComparison.OrdinalIgnoreCase) ||
               string.Equals(e.EventType, "life_whole_form_start", StringComparison.OrdinalIgnoreCase) ||
               string.Equals(e.EventType, "life_finalexpense_form_start", StringComparison.OrdinalIgnoreCase) ||
               string.Equals(e.EventType, "life_mp_form_start", StringComparison.OrdinalIgnoreCase) ||
