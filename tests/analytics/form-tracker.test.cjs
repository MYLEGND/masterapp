...
(async()=>{
 ...
 const expected=[{abandon:1,stage:['started']},{abandon:0},{attempts:1,abandon:0},{abandon:1},{abandon:0},{abandon:0},{sessionPresent:true,visitorPresent:true,utmSource:'qa_source',utmMedium:'qa_medium'},{abandon:0},{starts:0,abandon:1}];
