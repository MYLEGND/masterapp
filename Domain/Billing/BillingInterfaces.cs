...
public interface IBillingOrchestrator
{
    ...
    Task<ClientSubscriptionLifecycleResult> UpdateClientSubscriptionAsync(UpdateClientSubscriptionCommand command, CancellationToken cancellationToken = default);
