...
public class WorkstationController : Controller
{
    ...
    [IgnoreAntiforgeryToken] // Allow AJAX fetch from app without cookie/header mismatch blocking 400s
        ...
        [FromForm] Models.AdvancedMarketsPageViewModel model)
    {
        ...
        {
            Response.StatusCode = 500;
            return Content($"Advanced Markets calculate failed: {ex.Message}");
        }
    }
}
