...
public class MasterAppDbContext : DbContext
{
    ...
    public DbSet<LegendLanguageTextUnit> LegendLanguageTextUnits => Set<LegendLanguageTextUnit>();
    public DbSet<LegendGlobalConcept> LegendGlobalConcepts => Set<LegendGlobalConcept>();
    public DbSet<LegendTranslationAlignment> LegendTranslationAlignments => Set<LegendTranslationAlignment>();
    public DbSet<LegendTranslationQualityEvidence> LegendTranslationQualityEvidence => Set<LegendTranslationQualityEvidence>();
    public DbSet<LegendLanguageContextRelationship> LegendLanguageContextRelationships => Set<LegendLanguageContextRelationship>();
    public DbSet<LegendSemanticTransitionEvidence> LegendSemanticTransitionEvidence => Set<LegendSemanticTransitionEvidence>();
    public DbSet<LegendFounderSemanticExampleRelationEvidence> LegendFounderSemanticExampleRelationEvidence => Set<LegendFounderSemanticExampleRelationEvidence>();
    ...
    public DbSet<LegendLanguageTeacherProposal> LegendLanguageTeacherProposals => Set<LegendLanguageTeacherProposal>();
    public DbSet<LegendCurriculumFamily> LegendCurriculumFamilies => Set<LegendCurriculumFamily>();
    ...
    public DbSet<LegendLanguageDiscourseReferenceRule> LegendLanguageDiscourseReferenceRules => Set<LegendLanguageDiscourseReferenceRule>();
    public DbSet<LegendLanguageDiscourseReferenceRuleEvidence> LegendLanguageDiscourseReferenceRuleEvidence => Set<LegendLanguageDiscourseReferenceRuleEvidence>();
