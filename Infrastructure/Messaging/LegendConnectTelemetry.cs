...
public static class LegendConnectTelemetry
{
    ...
    private static readonly HashSet<string> DiagnosticReasonCodes = new(StringComparer.Ordinal)
    {
        ...
        "translation_capacity_configuration_unavailable",
        "translation_capacity_temporarily_unavailable",
        "translation_capacity_reservation_pending",
        "translation_capacity_hourly_exhausted",
        "translation_capacity_monthly_exhausted",
        "translation_capacity_request_exceeds_limit",
        "translation_provider_authentication_failed",
        "translation_provider_access_denied",
        "translation_provider_rate_limited",
        "translation_provider_transient_failure",
        "translation_provider_request_rejected",
