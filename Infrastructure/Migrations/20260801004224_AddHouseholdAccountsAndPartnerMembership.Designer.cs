...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260801004224_AddHouseholdAccountsAndPartnerMembership")]
    partial class AddHouseholdAccountsAndPartnerMembership
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ClientFinancialPlan", b =>
                {
                    ...
                    b.HasIndex("HouseholdAccountId", "IsDeleted")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.HouseholdMembership", b =>
                {
                    ...
                    b.HasIndex("ExternalIdentityObjectId", "Status")
                        .IsUnique();

                    b.HasIndex("HouseholdAccountId", "Role")
                        .IsUnique();

                    b.HasIndex("HouseholdAccountId", "NormalizedEmail", "Status")
                        .IsUnique();
