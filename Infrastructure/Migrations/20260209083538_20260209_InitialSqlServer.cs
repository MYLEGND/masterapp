        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentUpn = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignificantOtherFirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SignificantOtherLastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SignificantOtherDOB = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SignificantOtherEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SignificantOtherPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AgentNotes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
